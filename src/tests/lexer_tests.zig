...
test "Lexer: Final Test" {
    ...
    const test_tokens = [_]TestToken{
        ...
        .{ .expected_type = .INTEGER_TYPE, .expected_literal = "int" },
        ...
        .{ .expected_type = .BOOL_TYPE, .expected_literal = "bool" },
        .{ .expected_type = .ASSIGN, .expected_literal = "=" },
        .{ .expected_type = .FALSE, .expected_literal = "false" },
        .{ .expected_type = .SEMICOLON, .expected_literal = ";" },
        ...
        .{ .expected_type = .FLOAT_TYPE, .expected_literal = "float" },
        .{ .expected_type = .ASSIGN, .expected_literal = "=" },
        ...
        .{ .expected_type = .STRING_TYPE, .expected_literal = "string" },
        .{ .expected_type = .ASSIGN, .expected_literal = "=" },
        ...
        .{ .expected_type = .ANY_TYPE, .expected_literal = "any" },
        .{ .expected_type = .ASSIGN, .expected_literal = "=" },
        ...
        .{ .expected_type = .ERROR_TYPE, .expected_literal = "error" },
        .{ .expected_type = .ASSIGN, .expected_literal = "=" },
        ...
        .{ .expected_type = .RPAREN, .expected_literal = ")" },
        .{ .expected_type = .COLON, .expected_literal = ":" },
        .{ .expected_type = .VOID_TYPE, .expected_literal = "void" },
        .{ .expected_type = .LBRACE, .expected_literal = "{" },
        .{ .expected_type = .COMOT, .expected_literal = "comot" },
        .{ .expected_type = .SEMICOLON, .expected_literal = ";" },
        .{ .expected_type = .RBRACE, .expected_literal = "}" },
        ...
        .{ .expected_type = .INTERFACE_TYPE, .expected_literal = "interface" },
        .{ .expected_type = .ASSIGN, .expected_literal = "=" },
        .{ .expected_type = .LBRACE, .expected_literal = "{" },
        .{ .expected_type = .RBRACE, .expected_literal = "}" },
        .{ .expected_type = .SEMICOLON, .expected_literal = ";" },
